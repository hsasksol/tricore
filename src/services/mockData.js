...
// Keep backward compatibility for static chart data
export const mockChartData = {
  volume: {
    weeks: ['W1', 'W2', 'W3', 'W4', 'W5', 'W6'],
    swim: [2.5, 3.0, 2.8, 3.2, 2.0, 2.5],
    bike: [80, 120, 90, 140, 100, 45],
    run: [25, 30, 28, 35, 20, 14.5],
  },
  ...
  paceTrend: [
    {
      ...
      color: '#3d3d3d',
      data: [
        [Date.UTC(2024, 0, 1), 330],
        [Date.UTC(2024, 0, 8), 325],
        [Date.UTC(2024, 0, 15), 320],
        [Date.UTC(2024, 0, 22), 318],
        [Date.UTC(2024, 0, 29), 315],
      ],
    },
    {
      name: 'Swim (per 100m)',
      color: '#000',
      data: [
        [Date.UTC(2024, 0, 1), 115],
        [Date.UTC(2024, 0, 8), 112],
        [Date.UTC(2024, 0, 15), 110],
        [Date.UTC(2024, 0, 22), 108],
        [Date.UTC(2024, 0, 29), 105],
      ],
    },
  ],

  hrZones: { zone1: 15, zone2: 35, zone3: 25, zone4: 18, zone5: 7 },

  trainingLoad: {
    weeks: ['W1', 'W2', 'W3', 'W4', 'W5', 'W6'],
    tss: [280, 350, 320, 420, 290, 180],
  },
};
